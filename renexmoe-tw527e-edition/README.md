...
此版本由 [@TW527E](https://github.com/TW527E) 維護，作用於 [onemanager-pan](https://github.com/Etongxue/onemanager-pan)
...
2. 選擇 **`首頁`** 頁面
3. 在 **`Update from`** 選擇 `Github` `TW527E` `onemanager-pan` `master`
4. 點擊 **`一鍵更新`**
5. 等待更新，完成
